...
class Usmsgh_WooCommerce_Hook implements Usmsgh_Register_Interface {
	protected $notification_ins;

	public function __construct( Usmsgh_WooCommerce_Notification $notification_ins ) {
		$this->notification_ins = $notification_ins;
	}

	public function register() {
		usmsgh_add_actions( $this->get_core_actions() );
	}
